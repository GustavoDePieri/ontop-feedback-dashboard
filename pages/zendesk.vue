    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10">
        ...
        <div v-if="loading" class="text-center py-20 fade-in">
          ...
          <p class="text-white font-medium mt-6 text-lg">Loading tickets...</p>
          <p v-if="tickets.length > 0" class="text-gray-400 mt-2 text-sm">Loaded {{ tickets.length }} tickets so far...</p>
          <p v-else class="text-gray-400 mt-2 text-sm">Fetching data from Zendesk</p>
          <!-- Skeleton loaders -->
